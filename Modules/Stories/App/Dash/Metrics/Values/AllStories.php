...
namespace Modules\Stories\App\Dash\Metrics\Values;

use Dash\Extras\Metrics\Value;
use Modules\Stories\App\Models\Story;

class AllStories extends Value
{
    ...
    {
        return
            $this->count(Story::class)
            ->column(4)
            ->href(dash('resource/Stories'))
            ->icon('<i class="fa fa-book" aria-hidden="true"></i>')
            ->title(__('dash.Stories'))
            ->prefix('<i class="fa fa-book" aria-hidden="true"></i>');
    }
