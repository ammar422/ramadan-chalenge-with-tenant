...
namespace Modules\Partners\App\Dash\Metrics\Values;

use Dash\Extras\Metrics\Value;
use Modules\Partners\App\Models\Partner;

class AllPartners extends Value
{
    ...
    {
        return
            $this->count(Partner::class)
            ->column(4)
            ->href(dash('resource/Partners'))
            ->icon('<i class="fa-solid fa-handshake"></i>')
            ->title(__('dash.Partners'))
